...
const translationData = {
  en: {
    ...
    portfolioChartPlaceholder: 'Portfolio chart visualization would go here',
    stocks: 'Stocks',
    bonds: 'Bonds',
    cash: 'Cash',
    ...
    vacationSavings: 'Vacation Savings',
    homeDownPayment: 'Home Down Payment',
    financialInsights: 'Financial Insights',
    positiveTrend: 'Positive Trend',
    positiveTrendDescription: 'Your savings rate has increased by 3.1% compared to last month. Keep up the good work!',
    suggestion: 'Suggestion',
    suggestionDescription: 'Consider increasing your retirement contributions to maximize tax benefits.',
    opportunity: 'Opportunity',
    opportunityDescription: 'Based on your spending patterns, you could save an additional $250 monthly by optimizing subscriptions.',
  ...
  fr: {
    ...
    portfolioChartPlaceholder: 'La visualisation du graphique du portefeuille irait ici',
    stocks: 'Actions',
    bonds: 'Obligations',
    cash: 'Liquidités',
    ...
    vacationSavings: 'Économies pour Vacances',
    homeDownPayment: 'Apport pour Maison',
    financialInsights: 'Insights Financiers',
    positiveTrend: 'Tendance Positive',
    positiveTrendDescription: 'Votre taux d\'épargne a augmenté de 3,1% par rapport au mois dernier. Continuez comme ça!',
    suggestion: 'Suggestion',
    suggestionDescription: 'Envisagez d\'augmenter vos cotisations de retraite pour maximiser les avantages fiscaux.',
    opportunity: 'Opportunité',
    opportunityDescription: 'Selon vos habitudes de dépenses, vous pourriez économiser 250€ supplémentaires par mois en optimisant vos abonnements.',
